...
description: Audit knowledge management vaults and software R&D projects — structure, naming, MOC load, frontmatter, link hygiene, governance boundaries, lifecycle references, and concept-scope alignment.
triggers:
  - "pjx-common-auditor"
  - "pjx common"
  - "通用项目审计"
...
- `07-治理/skill规范/` — 整改台账目录
- `references/naming-rules.md` — 软件研发项目命名详细规则
